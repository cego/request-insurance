...
Route::namespace('Cego\RequestInsurance\Controllers')
    ...
    ->group(function () {
        ...
        Route::delete('request-insurances/{request_insurance_edit}/delete_edit', [
        ...
        Route::delete('request-insurances/{request_insurance_edit_approval}/remove_edit_approval', [
